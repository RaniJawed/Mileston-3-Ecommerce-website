    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div className="flex-1 mb-8 sm:mb-0 text-center sm:text-left">
          <h2 className="text-4xl sm:text-5xl font-bold font-serif text-yellow-500 mb-4">Styles & Heaven</h2>
        ...
        <div className="flex-1 text-center sm:text-left">
          <div className="mb-8 flex justify-center sm:justify-start space-x-6">
            ...
            <a href="
          https://github.com/RaniJawed/" target="_blank" rel="noopener noreferrer" className="text-yellow-500 hover:text-white transition-all">
          <FaGithub size={28} />
            </a>
         
            <a href="https://www.linkedin.com/in/rani-jawed-470a85245/"   target="_blank" rel="noopener noreferrer" className="text-yellow-500 hover:text-white transition-all">
            <FaLinkedin size={28} />
            </a>
            <a href=" https://www.pinterest.com/shaikhrj65/
            // /"target="_blank" rel="noopener noreferrer" className="text-yellow-500 hover:text-white transition-all">
            <FaPinterest size={28} />
            </a>
          </div>
